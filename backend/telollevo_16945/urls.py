"""telollevo_16945 URL Configuration
...
admin.site.site_header = "Telollevo"
admin.site.site_title = "Telollevo Admin Portal"
admin.site.index_title = "Telollevo Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Telollevo API",
        default_version="v1",
        description="API documentation for Telollevo App",
    ),
    public=True,
